    ...
    <div class="page-desc">
      <b-container>
        <b-row>
          <b-col md="7">
            <h3>Data & Grafik</h3>
            <h6>Pada tahun 2001, Indonesia memiliki 93,8 juta hektar hutan primer , yang mencakup lebih dari 50% wilayah daratannya. Pada tahun 2019, ia kehilangan 324kha hutan primer , setara dengan 187 juta ton CO₂ dari emisi.</h6>
          </b-col>
        </b-row>
      </b-container>
    </div>
      ...
      <b-container>
        <b-row>
          <b-col md="8">
            ...
            <line-chart :data="kebMingguan" :options="kebMingguanOpt" class="charts" />

            <h6 class="charts-title">Data peringatan kebakaran kumulatif</h6>
            <div class="compare-select">
              <label class="mr-sm-2" for="inline-form-custom-select-pref">Bandingkan dengan</label>
              <b-form-select
                id="inline-form-custom-select-pref"
                class="mb-2 mr-sm-2 mb-sm-0"
                v-model="compareYear"
                :options="['Tahun 2019', 'Tahun 2018', 'Tahun 2017', 'Tahun 2016']"
                :value="null"
              ></b-form-select>
            </div>
            <line-chart :data="kebKumulatif" :options="kebKumulatifOpt" class="charts" />

            <h6 class="charts-title">Luas kebakaran hutan dan lahan</h6>
            <b-row class="align-items-center">
              <b-col md="6">
                <pie-chart :data="kebLuas" :options="kebLuasOpt" class="charts" />
              </b-col>
              <b-col md="6">
  ...
  data(){
    return{
      ...
      kebLuas: {
        ...
        datasets: [{
          data: [165483.92, 529266.64, 1649258.00, 43834.00],
